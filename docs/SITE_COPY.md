...
> nota `> Intento` con lo scopo e lo stile, e poi il testo da inserire *verbatim*. Non riscrivere
> il testo: incollalo. Adatta solo il markup (h1/h2/p/button) alla struttura della landing. Tono
> di tutto il sito: editoriale, premium, asciutto, mai marketing generico, mai esclamativi. Palette
> Obsidian Intelligence (Deep Violet #6B21E8, Crimson #B8005C, Precision Teal #00A896) su fondo
> scuro. Tipografia con forte contrasto, titoli grandi e netti.
...
**H1 (versione principale):**
> Dietro ogni volto, una persona vera.
...
**Varianti H1 alternative** (se la principale non convince):
- *Inversione:* «Per anni l'AI ha preso i nostri volti. Adesso li chiede in prestito. E li paga.»
- *Categorica:* «Nessun volto finto. Mai più.»
- *Promessa:* «Volti reali. Diritti reali. Guadagni reali.»
...
> spiegazione. Cuore editoriale del sito: contrasto tipografico massimo. Sezione full-screen dedicata.
...
**Chiusura del manifesto (riga finale, grande):**
...
**Titolo:** Volti che puoi usare senza paura.

> Ogni persona del nostro catalogo è verificata e consenziente, per le categorie che vedi dichiarate.
> Niente cause sul diritto d'immagine, niente volti rubati, niente sintetico spacciato per reale.
> Solo persone vere, con una prova di provenienza allegata a ogni contenuto che generi.

**CTA:** Sfoglia il catalogo verificato
...
**Titolo:** La prova è parte del prodotto.
...
**CTA primaria:** Entra in HUMAN2AI
...
- La sezione **[MANIFESTO / VISION]** è quella a cui dare più peso visivo: sezione full-screen
  dedicata, non un blocchetto tra gli altri. È il cuore del sito.
- Ordine dei blocchi: Hero → Tensione → Manifesto → Come funziona → Sellers → Buyers → Fiducia →
  CTA finale → Footer. (La PublicRoadmap resta tra registro e CTA finale.)
- Non aggiungere testo non presente qui. Se manca un pezzo, segnalalo e chiedi, non inventarlo.
- Le CTA rimandano a rotte reali: `/match` (catalogo), `/signup` (onboarding), `/verify`, `/passport`.
