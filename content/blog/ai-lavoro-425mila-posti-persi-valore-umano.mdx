...
<figure style="margin:1.5em 0;"><img src="https://d8j0ntlcm91z4.cloudfront.net/user_397GKdSyAjnWj4e96AnXoJK2zTE/hf_20260616_145817_7edb6ffa-9d0f-4fad-a14b-65371fc2638e.png" alt="Mani aperte che reggono una costellazione di particelle che disegna un profilo umano" style="width:100%;border-radius:16px;" loading="lazy" /><figcaption style="font-size:0.8em;color:var(--text-muted);margin-top:0.5em;">Ciò che la macchina non può prendere senza permesso resta la persona: volto, voce, consenso. Illustrazione SEMBLIC.</figcaption></figure>
