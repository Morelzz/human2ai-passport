...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticRoutes = ["", "/match", "/brand", "/entra", "/catalogo", "/scansione", "/scansione/prenota", "/prezzi", "/trasparenza", "/verify", "/sviluppatori", "/faq", "/blog", "/academy", "/partner", "/studio", "/enterprise", "/enterprise/register", "/contatti", "/ai-act", "/ward", "/tutela", "/report", "/badge", "/signup", "/privacy", "/termini", "/cookie"]
    .map((p) => ({
      url: `${BASE}${p}`,
