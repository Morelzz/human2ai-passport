    ...
    <Link href={`/passport/${handle}`} style={{ textDecoration: "none" }}>
      <div
        style={{
          ...
          border: `1px solid ${isRevoked ? "rgba(238,122,112,0.2)" : "var(--hairline)"}`,
          borderRadius: 16,
          padding: "1.25rem",
          cursor: "pointer",
        ...
        onMouseLeave={e => {
          (e.currentTarget as HTMLDivElement).style.borderColor = isRevoked ? "rgba(238,122,112,0.2)" : "var(--hairline)";
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.25rem" }}>
            <span style={{ color: "var(--text)", fontWeight: 700, fontSize: "1rem" }}>{alias}</span>
            {isRevoked && (
              <span style={{ color: "var(--blocked-c)", fontSize: "0.65rem", fontWeight: 700, background: "rgba(238,122,112,0.12)", border: "1px solid rgba(238,122,112,0.3)", borderRadius: 999, padding: "0.1rem 0.4rem" }}>
                REVOCATO
              </span>
            )}
          </div>
