...
import { colors, gradient, page, buttonPrimary, buttonSecondary } from "@/lib/ui";
import { Nav } from "./Nav";
  ...
  return (
    <div style={page}>
      <Nav
        right={
          <>
            <Link href="/match" style={{ color: colors.muted, fontSize: "0.85rem", textDecoration: "none" }}>
              Trova un volto
            </Link>
            <Link href="/pricing" style={{ color: colors.muted, fontSize: "0.85rem", textDecoration: "none" }}>
              Prezzi
            </Link>
            <Link href="/trasparenza" style={{ color: colors.muted, fontSize: "0.85rem", textDecoration: "none" }}>
              Trasparenza
            </Link>
            {firstName ? (
              ...
              <Link href="/login" style={{ color: colors.muted, fontSize: "0.85rem", textDecoration: "none" }}>
                Accedi
              </Link>
            )}
            <Link href="/verify" style={{ color: colors.teal, fontSize: "0.85rem", textDecoration: "none", border: "1px solid rgba(0,168,150,0.3)", borderRadius: 999, padding: "0.4rem 1rem" }}>
      ...
      <section style={{ textAlign: "center", padding: "5rem 1.5rem 3rem" }}>
        ...
        <div style={{ display: "flex", gap: "0.75rem", justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="/match" style={buttonPrimary}>
            Trova un volto
          </Link>
          <Link href="/pricing" style={buttonSecondary}>
            Vedi i prezzi
          </Link>
        </div>
      </section>
