...
// nessun dato esterno o font da caricare.
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <div style={{ display: "flex", border: "2px solid #00d4be", borderRadius: 999, padding: "8px 22px", fontSize: 22, color: "#00d4be", letterSpacing: "0.06em" }}>
