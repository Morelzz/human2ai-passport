...
export const metadata = {
  ...
  description:
    "Scegli un volto del registro, con un consenso esplicito e verificabile, e genera contenuti che pagano la persona reale. Solo identità verificate, mai volti inventati.",
};
