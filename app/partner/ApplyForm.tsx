  ...
  return (
    <form onSubmit={submit} className="flex flex-col gap-4">
      ...
      <button type="submit" disabled={sending}
        className="mt-1 rounded-xl bg-[#F2A93B] px-6 py-3.5 text-sm font-bold text-[#412402] shadow-[0_8px_40px_rgba(242,169,59,0.3)] transition-all hover:brightness-110 disabled:opacity-50">
