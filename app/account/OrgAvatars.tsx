  ...
  if (kyb === null) {
    return (
      <div style={{ background: tint.violet, border: `1px solid ${tint.violetBorder}`, borderRadius: radius.md, padding: "1rem 1.1rem", marginBottom: "1rem" }}>
        ...
        <Link href="/enterprise/register" style={{ display: "inline-block", background: gradient, color: "var(--on-amber-c)", fontWeight: 700, fontSize: "0.78rem", textDecoration: "none", borderRadius: radius.sm, padding: "0.5rem 0.9rem" }}>
          Registra l&apos;azienda
        </Link>
      </div>
    );
  ...
  return (
    <div style={{ background: colors.panel, border: `1px solid ${colors.border}`, borderRadius: radius.lg, padding: "1.5rem", marginTop: "1.2rem" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem", flexWrap: "wrap", gap: "0.5rem" }}>
        ...
        {approved ? (
          <Link href="/account/avatar" style={{ background: gradient, color: "var(--on-amber-c)", fontWeight: 700, fontSize: "0.8rem", textDecoration: "none", borderRadius: radius.md, padding: "0.5rem 1rem" }}>
            + Onboarda avatar
          </Link>
        ) : (
